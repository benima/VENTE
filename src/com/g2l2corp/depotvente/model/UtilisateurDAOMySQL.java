...
public class UtilisateurDAOMySQL implements UtilisateurDAO {
	...
	private static final String FINDALBYPROP_utilisateurs = "SELECT * FROM utilisateur ";
	private static final String AUTHENTIF = " select * from utilisateurs where pseudo=? and password=?";
	DataSource ds=null;
	...
	@Override
	public Utilisateur verif(String pseudo, String pwd) throws DAOException {
